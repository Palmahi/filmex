...
async function seed () {
  ...
  const movies = await Promise.all([
    ...
    rating: '3'}),
    Movie.create({title: 'Casablanca', year: '1942', director: 'Michael Curtiz', duration: '103', description: "Rick Blaine (Humphrey Bogart), who owns a nightclub in Casablanca, discovers his old flame Ilsa (Ingrid Bergman) is in town with her husband, Victor Laszlo (Paul Henreid). Laszlo is a famed rebel, and with Germans on his tail, Ilsa knows Rick can help them get out of the country.", poster:'https://st.kp.yandex.net/im/poster/1/4/3/kinopoisk.ru-Casablanca-1430038.jpg',
    rating: '5'}),
